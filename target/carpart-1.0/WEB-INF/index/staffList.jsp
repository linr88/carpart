          ...
          <div class="pagebody11_top"><!--输入用户名-->
          	<form id="searchStaffForm" name="searchStaffForm" action="${ctx}/staff/staffList" method="post">
                    <ul>
                      ...
                      <li ><input type="text" name="loginName" id="username" class="cha1"  value="${vo.loginName}"/></li>
                      ...
                      <table width="1000" border="0"  class="dsfd yuan" >
                          <c:forEach var="staff" items="${staffList}" varStatus="status">
                              <tr>
                                ...
                                <td width="80"><c:if test="${staff.manageLevel==4}">普通员工</c:if><c:if test="${staff.manageLevel==1}">管理员</c:if></td>
